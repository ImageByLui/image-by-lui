...
// =============================================================================
// Homepage — English (/) — V7 (LUI-DESK-007)
// =============================================================================
// White background (#FFFFFF) via [data-page="home"] in globals.css.
// Desktop hero bleeds LEFT (reversed from service pages).
// No alternating section backgrounds. No gold separator lines.
// =============================================================================

const c = homeContent;

export const metadata: Metadata = {
  ...buildPageMetadata(c.seo, "en", "home"),
  openGraph: {
    ...
    <div data-page="home">
      ...
      <section id="hero" className="relative overflow-hidden lg:min-h-[calc(100vh-64px)] lg:flex lg:items-center">
        ...
        <div className="lg:hidden text-center" style={{ padding: "0 36px", marginTop: -20 }}>
          ...
          <div className="pt-7 pb-0" style={{ padding: "28px 40px 0" }}>
            <a
        ...
        <div className="hidden lg:block" style={{ marginRight: "auto", maxWidth: 460, paddingLeft: 48 }}>
          <ScrollReveal>
            ...
            <div className="flex items-center gap-6">
              <Link href={c.meetLu.learnMoreHref} className="font-body font-medium text-[13px] text-terracotta no-underline hover:underline">Learn more about Lu →</Link>
