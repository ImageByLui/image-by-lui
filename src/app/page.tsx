...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* 1. HERO                                                          */}
      {/* ----------------------------------------------------------------- */}
      <section className="bg-gradient-to-br from-warm-ivory to-champagne">
        {/* Desktop: text left, Lu right (cropped upper body) */}
        ...
        {/* Mobile: Lu above (cropped), text below */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-14 items-start max-w-[960px] mx-auto">
            <ScrollReveal>
              <ImagePlaceholder
                ...
                alt="Lu at a professional event in Miami surrounded by tropical greenery"
                width={600}
                height={600}
                colorIndex={1}
                className="w-full"
