...
// Homepage — English (/) — V4
// =============================================================================
// Desktop order: Hero → Persona → How It Works → Services → ...
// Mobile order:  Hero → How It Works → Services → Persona → ...
// (Persona moved below services on mobile — too long before the CTA)
// =============================================================================
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ----------------------------------------------------------------- */}
      {/* Sections 2-4: Reordered on mobile via flex order                  */}
      {/* Desktop: Persona → How It Works → Services                       */}
      {/* Mobile:  How It Works → Services → Persona                       */}
      {/* ----------------------------------------------------------------- */}
      <div className="flex flex-col">

        {/* 2. Who Is This For — Soft Stone */}
        {/* Desktop: first (order-1). Mobile: last of three (order-3) */}
        ...
        {/* Desktop: second (order-2). Mobile: first (order-1) */}
        ...
        {/* Desktop: third (order-3). Mobile: second (order-2) */}
                ...
                {paidCards.map((card, i) => (
                  <ScrollReveal key={card.name} delay={i * 100}>
                    ...
                    >
                      ...
                      {/* Details line — consistent style for both cards */}
                      {card.detailsLine && (
                      ...
                      {/* CTA — text link on mobile, button on desktop */}
      ...
      {/* Larger aspect ratio for real photos                              */}
      {/* ----------------------------------------------------------------- */}
      <section className="bg-warm-ivory">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <ScrollReveal>
      ...
      {/* Desktop: has button. Mobile: text only (sticky bar handles it)   */}
      {/* ----------------------------------------------------------------- */}
