...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Three tiers from $250. We analyze your event, curate your look, ensure you arrive ready. Bilingual service.",
    images: [{ url: "/og/occasion-styling.jpg", width: 1200, height: 630, alt: "Image by LUI — Occasion Styling in Miami" }],
    locale: "en_US",
    type: "website",
  },
};
...
export default function OccasionStylingPage() {
  return (
    <>
      ...
      {/* Bottom CTA — WhatsApp primary + FAQ link */}
      <BottomCTASection>
