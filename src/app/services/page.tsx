  ...
  return (
    <>
      ...
      <div className="bg-warm-ivory py-3 px-5 text-center">
        <p className="font-heading font-light italic text-caption text-warm-taupe">Trusted by professionals across Miami-Dade County</p>
      </div>
      ...
      <BottomCTASection>
        ...
        <a href={content.bottomCta.primaryCta.href} target="_blank" rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2.5 bg-[#25D366] text-white font-body font-semibold text-cta tracking-[1px] uppercase px-8 py-4 no-underline hover:no-underline transition-colors duration-150 active:bg-[#1DA851] focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2">
