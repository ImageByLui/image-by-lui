...
export default function ServicesPage() {
  return (
    <>
      ...
      {/* V2 fix 3d: Trust indicator */}
      <div className="bg-warm-ivory py-3 px-5 text-center">
        <p className="font-heading font-light italic text-[13px] text-warm-taupe">Trusted by professionals across Miami-Dade County</p>
      </div>
      <section className="bg-warm-ivory pt-4 px-3.5 pb-3.5" aria-label="Our services">
      ...
      <BottomCTASection>
        ...
        <a href={content.bottomCta.primaryCta.href} target="_blank" rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2.5 bg-[#25D366] text-white font-body font-semibold text-[14px] tracking-[1px] uppercase px-8 py-4 no-underline hover:no-underline transition-colors duration-150 active:bg-[#1DA851] focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2">
        ...
        <p className="font-body text-[13px] text-warm-ivory/60 mt-3">
