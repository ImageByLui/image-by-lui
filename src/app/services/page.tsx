  ...
  return (
    <>
      ...
      <section className="bg-warm-ivory pt-4 px-3.5 pb-3.5 lg:hidden" aria-label="Our services">
        <p className="font-heading font-semibold text-[24px] text-espresso text-center mb-1">{content.selector.heading}</p>
      ...
      {/* §2.7 Bottom CTA — responsive: WhatsApp primary on mobile, Calendly on desktop */}
      <BottomCTASection>
          ...
          <div className="hidden lg:block">
            ...
            <p className="font-body text-[13px] text-warm-ivory/30 mt-[18px]">
              ...
              <a href={desktop.bottomCta.secondaryLinkHref} target="_blank" rel="noopener noreferrer" className="text-[#25D366] font-medium no-underline hover:opacity-80 transition-opacity">
                WhatsApp{desktop.bottomCta.secondaryText.includes("WhatsApp") ? "" : ""}
              </a>
            </p>
          </div>
        )}
