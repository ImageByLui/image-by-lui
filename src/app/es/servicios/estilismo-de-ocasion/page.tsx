...
export const metadata: Metadata = { ...buildPageMetadata(content.seo, "es", "occasionStyling"), alternates: { canonical: "/es/servicios/estilismo-de-ocasion", languages: { en: "/services/occasion-styling", es: "/es/servicios/estilismo-de-ocasion", "x-default": "/services/occasion-styling" } }, openGraph: { title: "Estilismo de Ocasión — Bodas, Galas, Conferencias | Miami", description: "Tres niveles desde $250.", images: [{ url: "/og/occasion-styling.jpg", width: 1200, height: 630 }], locale: "es_US", type: "website" } };
export default function EstilismoDeOcasionPage() {
  return (<>
    ...
    <BottomCTASection>
      ...
      <p className="font-body text-[13px] text-warm-ivory/60 mt-2"><Link href={content.bottomCta.faqLinkHref} className="text-warm-ivory/60 hover:text-warm-ivory transition-colors duration-150 no-underline hover:underline">{content.bottomCta.faqLinkText}</Link></p>
    </BottomCTASection>
