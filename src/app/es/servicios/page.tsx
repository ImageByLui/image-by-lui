...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: { en: "/services", es: "/es/servicios", "x-default": "/services" },
  },
  openGraph: {
    title: "Consultoría de Imagen y Estilismo de Ocasión en Miami",
    description: "Estrategia de imagen profesional basada en colorimetría y ciencia del estilo. Análisis de color de cortesía disponible. Bilingüe EN/ES.",
    images: [{ url: "/og/services-overview.jpg", width: 1200, height: 630, alt: "Image by LUI — Consultoría de Imagen y Estilismo en Miami" }],
    locale: "es_US",
    type: "website",
  },
};
...
export default function ServiciosPage() {
  return (
    <>
      ...
      <FreeSessionCard
        imageAlt={content.freeSession.imageAlt} title={content.freeSession.title}
        subtitle={content.freeSession.subtitle} description={content.freeSession.description}
        deliverables={content.freeSession.deliverables} cta={content.freeSession.cta}
      ...
      <section className="bg-warm-ivory pt-7 px-3.5 pb-3.5" aria-label="Nuestros servicios">
        <p className="font-body font-semibold text-[12px] text-espresso text-center tracking-[1px] uppercase mb-1">{content.selector.heading}</p>
        <p className="font-body text-[12px] text-warm-taupe text-center leading-[1.5] mb-[22px]">{content.selector.subheading}</p>
