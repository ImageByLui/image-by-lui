      ...
      <div className="p-folio-desktop">
          <div className="p-folio-grid">
            ...
            <div className="p-folio-gi p-reveal-scale p-delay-2">
              <Image src={IMAGES.portfolio[3].src} alt={IMAGES.portfolio[3].alt} width={600} height={800} style={{ filter: BRAND_FILTER, objectPosition: "65% 50%" }} loading="lazy" sizes="30vw" />
              <PortfolioCaption index={3} locale={locale} />
            </div>
