...
// =============================================================================
// Section 2. White card with gold border on stone bg.
// Price + strikethrough → gold note → separator → 3-column summary.
// =============================================================================
  ...
  return (
    <section className="bg-soft-stone py-7 px-5" aria-label="Pricing">
      <div className="bg-white border border-gold py-6 px-5 text-center">
        ...
        {/* Gold note */}
        <p className="font-body font-semibold text-[11px] tracking-[1.2px] uppercase text-gold mb-[18px]">
          {priceNote}
        </p>
          ...
          {summary.map((col, i) => (
            <div key={i} className="flex items-start flex-1">
              ...
              <div className="flex-1 text-center px-1.5">
                ...
                <p className="font-body text-[12px] text-warm-taupe">{col.label}</p>
              </div>
            </div>
          ))}
        </div>
