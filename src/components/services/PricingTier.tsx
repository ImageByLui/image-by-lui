...
// =============================================================================
// Renders a pricing tier using AccordionCard as base. Three visual variants:
...
const STYLES = {
  essential: {
    border: "border border-champagne/50",
    summaryPt: "pt-5",
    nameSize: "text-[20px]",
    priceSize: "text-[20px]",
  ...
  complete: {
    border: "border-[1.5px] border-terracotta relative",
    summaryPt: "pt-[30px]",
    nameSize: "text-[22px]",
    priceSize: "text-[22px]",
    priceCls: "text-terracotta",
  ...
  vip: {
    border: "border border-gold/50 border-t-[3px] border-t-gold",
    summaryPt: "pt-5",
    nameSize: "text-[20px]",
    priceSize: "text-[20px]",
    priceCls: "text-gold",
...
/** Shared chevron SVG for all tier variants */
function Chevron() {
  return (
...
export default function PricingTier({
  name, price, subtitle, duration, description, inclusions,
  ctaText, ctaHref, variant, badge, imageAlt, footnote, defaultOpen = false,
}: PricingTierProps) {
  ...
  return (
    ...
    >
      <div className="px-5 pb-6">
        ...
        <p className="font-body text-[14px] text-warm-grey leading-[1.6] mb-[18px]">{description}</p>
        ...
        {footnote && (
          <p className="font-heading font-light italic text-[12px] text-gold mt-3.5">{footnote}</p>
        )}
