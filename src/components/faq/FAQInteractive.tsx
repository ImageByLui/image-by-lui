...
// =============================================================================
// FAQInteractive — Image by LUI (FAQ)
// =============================================================================
// Client component that manages category pill state.
// ALL categories are rendered in the DOM (CSS display toggle, not conditional
// rendering) so all 15 answers are crawlable by search engines and AI.
// =============================================================================
  ...
  return (
    <>
      ...
      <section className="bg-warm-ivory pt-8 px-5 pb-6" aria-label="Hero">
        <p className="font-body font-semibold text-[10px] tracking-[2px] uppercase text-terracotta mb-3">
          {content.hero.label}
        </p>
        ...
        <p className="text-[15px] text-warm-grey leading-[1.6]">
      ...
      {/* 3. FAQ Categories — ALL rendered, CSS display toggle */}
      <section className="bg-soft-stone py-5 px-3.5" aria-label="Frequently asked questions" ref={faqSectionRef}>
        {content.categories.map((cat: FAQCategory) => (
          <div
            key={cat.id}
            style={{ display: cat.id === activeCategory ? "block" : "none" }}
          >
            ...
            <CategoryCrossLinks
              text={cat.crossLinks.text}
              links={cat.crossLinks.links}
      ...
      {/* 4. Bottom CTA — side-by-side buttons */}
      <BottomCTASection>
        <h2 className="font-heading font-normal text-[22px] text-warm-ivory mb-2.5">
          {content.bottomCta.heading}
        </h2>
        <p className="font-body text-[14px] text-warm-ivory/60 leading-[1.6] mb-[22px]">
        ...
        <div className="flex gap-2.5">
          ...
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-white text-espresso font-body font-semibold text-[11px] tracking-[0.8px] uppercase py-[15px] px-2.5 no-underline hover:no-underline transition-colors duration-150 active:bg-warm-ivory focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2"
          >
