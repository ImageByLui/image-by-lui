  ...
  return (
    <details className="group bg-white border-l-[3px] border-l-gold mb-2.5 shadow-[0_1px_4px_rgba(44,36,32,0.06)]" open={defaultOpen || undefined}>
      <summary className="flex items-start gap-3.5 py-[18px] px-4 cursor-pointer list-none [&::-webkit-details-marker]:hidden">
        <span className="font-heading font-medium text-faq-q text-espresso leading-[1.35] flex-1">{question}</span>
      ...
      <div className="accordion-content"><div>
        <div className="px-4 pb-5">
          ...
          <div className="font-body text-inclusion text-warm-grey leading-[1.65] [&_strong]:text-espresso [&_strong]:font-semibold [&_a]:text-terracotta [&_a]:font-semibold [&_a]:no-underline" dangerouslySetInnerHTML={{ __html: answer }} />
        </div>
      </div></div>
    </details>
  );
